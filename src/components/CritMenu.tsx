...
export default function CritMenu() {
    ...
    // const [totalCrit, setTotalCrit] = useState(80);

    // const critMultiplier =
    //     (1 + (totals.cc / 100) * totals.cf) *
    //     (1 + (totals.scc / 100) * totals.scm);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border p-6 shadow-sm min-h-[300px]">
                ...
                {selectedSubStat === "Super Crit Mult" && <SCMInput />}
            </div>
        </div>
    );
}
